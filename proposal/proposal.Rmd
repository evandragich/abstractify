...
obtain all of its images from user input. In the interim we have created the 
exploration and project folders to aid our introductory exploration of the new 
packages and concepts we are working with.
